...
sap.ui.define([
		...
		return BaseController.extend("jorgcalleja.nerd.library.controller.Master", {
			...
			onSearch : function (oEvent) {
				...
				if (sQuery) {
					this._oListFilterState.aSearch = [new Filter("Nombre", FilterOperator.Contains, sQuery)];
				} else {
