sap.ui.define([
		...
		return BaseObject.extend("jorgcalleja.nerd.library.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias jorgcalleja.nerd.library.model.ListSelector
			 */
			 ...
			 * @return {jorgcalleja.nerd.library.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
