sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("jorgcalleja/nerd/library/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#Mibibliotecafriki-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#Mibibliotecafriki-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("jorgcalleja.nerd.library.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["jorgcalleja/nerd/library/localService/mockserver"], function (mockserver) {
